...
bool esMoldorm::animate(int index)
{
	...
	float tmpstep = ((8.0/(int)step));
        parentclk=((parentclk+1)%((int)tmpstep));
...
//  headtile=nets+5588;                                       //5580, actually.  must adjust for direction later on
    ...
    */
    ...
    case -1:                                                // got chopped off
    {
        ...
        clk2=40;
        dir=(rand()&7)+8;
	float tmpstep = 8.0/9.0;
	zfix newtmpstep = ((zfix)tmpstep);
        //step=8.0/9.0;
	step = newtmpstep;
    }
    break;
